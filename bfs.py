...
def find_all_paths2(maze, start, end):
    ...
    while queue:
        # Prendiamo il primo percorso dalla coda
        path = queue.pop(0)
        ...
        # Altrimenti, esploriamo le posizioni adiacenti
            ...
            for next_pos in get_adjacent_positions(maze, curr_pos):
                ...
                if next_pos not in path:
                    ...
                    # Aggiungiamo il nuovo percorso alla coda
...
for i in range(len(start)):
    paths.append(find_all_paths2(maze, start[i], end))
