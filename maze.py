...
class Maze:
    ...
    def load_maze(self):
        ...
        '''
        # # Se è un file immagine in formato png richiama il metodo image_to_maze
        ...
        # Se invece il file è in un formato immagine RGB, apre l'immagine e 
        # richiama direttamente il metodo image_to_maze
    ...
    def json_to_maze(self,data):
        ...
        start : list
            ...
            E' una lista con le coordinate di tutte le caselle rosse (punti di arrivo)
        image: TiffImageFile
            E' l'immagine Tiff del labirinto descritto dal Json generata dal
            metodo maze_to_image
        """
    ...
    def maze_to_image(self):
        ...
        self.img = Image.new("RGB", (len(self.maze[0]), len(self.maze)))
        pixels = self.img.load()
